    ...
    return (
        <div className={`${dafoe.className}`} onContextMenu={ (e) => e.preventDefault() }>
            ...
            <div className="w-10/12 mx-auto mt-8 shadow-md shadow-black hover:shadow-purple-900 hover:shadow-lg hover:scale-110 transition-all duration-200">
                <Link href="https://www.google.com/maps/place/Parroquia+del+Sagrado+Coraz%C3%B3n/@25.5753882,-103.5021557,17.33z/data=!4m6!3m5!1s0x868fd83b995d8295:0xd9a4bf3f72cfe5a7!8m2!3d25.5763156!4d-103.5006744!16s%2Fg%2F1wz5345d?entry=ttu" target="_blank">
                    <Image
            ...
            <div className="w-10/12 mx-auto mt-8 shadow-md shadow-black hover:shadow-purple-900 hover:shadow-lg hover:scale-110 transition-all duration-200">
                <Link href="https://www.google.com/maps/place/OneDay+Sal%C3%B3n+de+Eventos/@25.5742302,-103.5069134,17z/data=!3m1!4b1!4m6!3m5!1s0x868fd849bf9e00ef:0x4c6ed7f9eed66fba!8m2!3d25.5742264!4d-103.5048697!16s%2Fg%2F11g00cn2k2?entry=ttu" target="_blank">
                    <Image
