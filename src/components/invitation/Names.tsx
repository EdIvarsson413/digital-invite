...
export default function Names({ dafoe }: any) {
    return (
        <div>
            ...
            <p className="text-center text-2xl mt-2 text-shadow-sm shadow-purple-500">lorrem ipsun dolor</p>
            <p className="text-center text-2xl text-shadow-sm shadow-purple-500">lorrem ipsun dolor</p>
            
            <br />
            <p className={`${dafoe.className} text-5xl text-shadow shadow-black text-center mt-4`}>Mis Padrinos</p>
            <p className="text-center text-2xl mt-2 text-shadow-sm shadow-purple-500">lorrem ipsun dolor</p>
            <p className="text-center text-2xl text-shadow-sm shadow-purple-500 mb-10">lorrem ipsun dolor</p>
        </div>
    )
}